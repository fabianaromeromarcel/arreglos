const propiedades_venta = [
    ...
    {
        nombre: 'Apartamento familiar en la ciudad',
        src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSJCuVEH5XiMx_YLbkrREEsw0N0vRg0bz-hL3JTardrNIY_hdGF1hBW-M&s=10',
        descripcion: 'Este penthouse de lujo ofrece una terraza panorámica con vistas espectaculares.',
        ubicacion: '666 Goblin Avenue, Miau City, TX 56789',
        habitaciones: 3,
        costo: 3500,
        smoke: true,
        pets: false
...
for (let i = 0; i < 3; i++) {
    ...
    `;
    cardAlquiler.innerHTML += templateAlquiler;
}